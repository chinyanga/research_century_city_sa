...
class IDQNFixedBoundsTrafficAgent:
    ...
    def replay(self):
        ...
        # Predict Q-values for current states and next states (online and target)
...
def compute_phase_reward(agent, idx, step, duration, clearance_weight=1.8):
    ...
    # Duration alignment
    if congestion_level > 0.7 and duration < agent.max_green:
        duration_alignment_bonus = - (agent.max_green - duration) * 0.1
    elif congestion_level < 0.3 and duration > agent.min_green:
        duration_alignment_bonus = - (duration - agent.min_green) * 0.1
    ...
    print(
        ...
        f"CO2pen {norm_emission_penalty:.3f} | Duration {duration}"
    )
...
def plot_agent_metrics(agents):
    ...
    plt.title("I-DQN(Fixed Bounds) Average Queue per 100 Steps")
    ...
    plt.title("I-DQN(Fixed Bounds) Average Wait Time per 100 Steps")
    plt.xlabel("100-Step Interval")
    ...
    plt.title("I-DQN(Fixed Bounds) Throughput per 100 Steps")
    plt.xlabel("100-Step Interval")
   ...
   # 4. Cumulative queue
    ...
    plt.title("I-DQN(Fixed Bounds) Cumulative Average Queue Over Time")
    plt.xlabel("100-Step Interval")
    ...
    plt.title("I-DQN(Fixed Bounds) Cumulative Average Wait Over Time")
    plt.xlabel("100-Step Interval")
    ...
    plt.title("I-DQN(Fixed Bounds) Cumulative Throughput Over Time")
    plt.xlabel("100-Step Interval")
    ...
    plt.title("I-DQN(Fixed Bounds) Cumulative Co2 Over Time")
    plt.xlabel("100-Step Interval")
...
def plot_global_metrics(cum_avg_queue, cum_avg_wait, cum_node_throughput,cum_node_co2):
    ...
    plt.plot(steps, cum_avg_queue, label='I-DQN(Fixed Bounds) Cumulative Avg Queue', color='purple')
    plt.title("I-DQN(Fixed Bounds) Global Cumulative Average Queue Over Time")
    plt.xlabel("100-Step Interval")
    ...
    plt.figure(figsize=(8, 5))
    plt.plot(steps, cum_avg_wait, label='I-DQN(Fixed Bounds) Cumulative Avg Wait', color='brown')
    plt.title("I-DQN(Fixed Bounds) Global Cumulative Average Wait Time Over Time")
    plt.xlabel("100-Step Interval")
    plt.ylabel("Avg Wait (s)")
    plt.grid(True)
    plt.legend()
    ...
    plt.figure(figsize=(8, 5))
    plt.plot(steps, cum_node_throughput, label='I-DQN(Fixed Bounds) Cumulative Node Throughput', color='darkgreen')
    plt.title("I-DQN(Fixed Bounds) Global Cumulative Throughput (Node Sum) Over Time")
    plt.xlabel("100-Step Interval")
    ...
    plt.figure(figsize=(8, 5))
    plt.plot(steps, cum_node_co2, label='I-DQN(Fixed Bounds) Cumulative Node CO2', color='darkgreen')
    plt.title("I-DQN(Fixed Bounds) Global Cumulative Co2 (Node Sum) Over Time")
    plt.xlabel("100-Step Interval")
    plt.ylabel("Total Co2")
    plt.grid(True)
    plt.legend()
        ...
        for agent in agents:
            ...
            if agent.phase_timer <= 0:
                ...
                if agent.phase_state == "green":
                    ...
                    reward = compute_phase_reward(agent,idx, step, duration) 
